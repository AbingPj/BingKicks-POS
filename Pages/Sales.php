...
<body>
  ...
  <div class="container" style="min-height: 580px;">
    <ul class="nav nav-tabs" role="tablist">
      ...
      <li role="presentation"><a href="#ProductSales" aria-controls="Product Sales" role="tab" data-toggle="tab">Product
          Sales</a></li>
    </ul>
             ...
             //$query="SELECT * from salesview ORDER BY sales_number";
                  ...
                  <tr>
                    <td>
                      ...
                      <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#myModal<?php echo $row['sales_number']; ?>">view
                        details</a>
                      <div class="modal fade" id="myModal<?php echo $row['sales_number']; ?>" tabindex="-1" role="dialog"
...
//Date BETWEEN '$from' AND '$to'
            ...
            <tr>
              <td style="width: 12.5%;float: left; class=" filterable-cell">
                <?php echo "  " . $row3['product_id'] ?>
              </td>
              <td style="width: 12.5%;float: left; class=" filterable-cell">
                <?php echo "  " . $row3['name'] ?>
              </td>
